...
export const newUser = AsyncErrorHandler(async (req: Request<{}, {}, NewUserRequestBody>, res: Response, next: NextFunction) => {
...
export const getUser = AsyncErrorHandler(async(req, res, next) => {
    ...
    if(!user) return next(new CustomError("Invalid id", 400));
